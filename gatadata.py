...
conference = 'AAC' # str | Conference abbreviation filter (optional)
...
print("Teams have been collected...\n")
...
print("Rosters have been populated...\n")
############################################################################################
...
print("The data has been gathered....\n")
...
print("The stats per position have been grabbed....\n")
...
print("The stats are now assigned per person/id")
...
header = ['id', 'posStat1','posStat2']
with open('temp2.csv','w', encoding='UTF8', newline='') as f:
    writa = csv.writer(f)
    writa.writerow(header)
    for valz in players:
        temp = [valz, players[valz], players2[valz]]
        writa.writerow(temp)
    # for valz in players2:
    #     temp = [valz, players2[valz]]
    #     writa.writerow(temp)
